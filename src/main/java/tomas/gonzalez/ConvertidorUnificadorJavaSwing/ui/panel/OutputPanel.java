...
public class OutputPanel extends JPanel {
    ...
    private final JCheckBox overwriteCheck = new JCheckBox("Sobreescribir si existe");
    ...
    public OutputPanel(String defaultDir) {
        ...
        dirField.setToolTipText("Carpeta de destino");
        ...
        gc.gridx = 0; gc.gridy = 1; gc.weightx = 0; add(new JLabel("Nombre:"), gc);
